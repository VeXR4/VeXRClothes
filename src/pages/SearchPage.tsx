    ...
    <div className="pt-20 lg:pt-28">
      <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-8">
        <div className="py-8">
          ...
          <h1 className="mt-2 font-display text-3xl font-medium text-ink-900 sm:text-4xl">جستجو</h1>

          <form onSubmit={handleSubmit} className="mt-5 flex max-w-xl items-center gap-3 rounded-sm border border-ink-900/15 px-4 py-3">
            ...
            <input
              ...
              autoFocus
            />
            <button type="submit" className="text-sm font-medium text-ink-700 hover:text-ink-900">جستجو</button>
          </form>
        </div>
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center gap-4 py-20">
            <p className="text-sm text-ink-500">نتیجه‌ای برای «{query}» یافت نشد.</p>
          ...
          <>
            <p className="mb-6 text-sm text-ink-500">{products.length.toLocaleString('fa-IR')} نتیجه برای «{query}»</p>
