...
export default function NewProducts({ products }: Props) {
  ...
  return (
    <section id="new" className="bg-cream-dark dark:bg-night-900/60">
      <div className="mx-auto max-w-7xl px-6 py-20 sm:px-8 lg:py-28">
        <div className="mb-12 flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-end">
          <div>
            ...
            <h2 className="mt-3 font-display text-3xl font-medium text-ink-900 dark:text-night-50 sm:text-4xl">جدیدترین محصولات</h2>
          </div>
          <button onClick={() => navigate('/new')} className="group flex items-center gap-2 text-sm text-ink-600 dark:text-night-300 hover:text-ink-900 dark:text-night-50">
            مشاهده همه
